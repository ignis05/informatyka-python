# Podaj specyfikację oraz skonstruuj algorytm w postaci schematu blokowego i programu deszyfrujący
# kryptogram wczytywany z klawiatury uzyskany metoda płotową dla płotu wysokości 3.
